...
public final class JFlexSettingsForm implements PersistentStateComponent<JFlexSettings> {
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle(
            "de/jflex/ide/idea/util/JFlexBundle").getString("path.to.jflex"));
        ...
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle(
            "de/jflex/ide/idea/util/JFlexBundle").getString("skeleton.file"));
        ...
        this.$$$loadLabelText$$$(label3, ResourceBundle.getBundle(
            "de/jflex/ide/idea/util/JFlexBundle").getString("command.line.options"));
        ...
        this.$$$loadButtonText$$$(enabledEmbedJavaCheckBox, ResourceBundle.getBundle(
            "de/jflex/ide/idea/util/JFlexBundle").getString("enabled.embed.java.code.support"));
